        ...
        <div className="w-1/2 flex-col items-center border-2 border-emerald-300 border-dashed mt-40">
          <div className="flex items-top justify-between">
            <h1 className="text-emerald-300 p-5 text-4xl">
              Personnel File:{" "}
              <span className="text-emerald-200">Sebastian Molin</span>
            </h1>
          ...
          <div className="flex flex-col p-5">
            <h2 className="text-3xl">
              Occupation:{" "}
              <span className="text-emerald-200">Fullstack Web Developer</span>
            </h2>
            <h2 className="text-3xl pt-2">
              Current Assignment:{" "}
              <span className="text-emerald-200">Intern at Winlas AB</span>
            </h2>
            <h2 className="text-3xl pt-2">
              Resume: <span className="text-emerald-200">See </span>
              <a
            ...
            <h2 className="text-3xl pt-2">
              Last Known Location:{" "}
              <span className="text-emerald-200">The UCSS Nostromo</span>
            </h2>
          </div>
        </div>
      </section>
